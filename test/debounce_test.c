...
static void test_no_debounce(void **state) {
    (void)state;
    do_100_changes(0);
}

static void test_1_debounce(void **state) {
    (void)state;
    do_100_changes(1);
}

static void test_100_debounce(void **state) {
    (void)state;
    do_100_changes(100);
}


static void test_interrupt_change(void **state) {
    (void)state;
    debounce_filter_init(&filter);
    debounce_filter_set(&filter, 0);
